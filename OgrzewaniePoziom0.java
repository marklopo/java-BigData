...
public class OgrzewaniePoziom0 implements IStatusOgrzewanie, IKosztOgrzewanie, IOpoznienie {
	public void ogrzewaj0(JPanel panel, String poziom, String obiekt, JTextField identyfikacja, double pobor,
		...
		if (panel.getBackground().equals(Color.gray)) {
			...
			timer.scheduleAtFixedRate(new TimerTask() {
				...
				public void run() {
					...
					PoborOgrzewanie0.poborOgrzewanie0(temp_a, temp_p, pobor);

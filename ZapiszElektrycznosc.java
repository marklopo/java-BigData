...
public class ZapiszElektrycznosc {
	public static void zapisz(String id, String rok, String data, String poziom, String obiekt, double pobor) {
		rok = Menu.a_rok.getText();

		data = Menu.a_miesiac.getText();

		try {
			String prad = "insert into elektrycznosc values (?,?,?,?,?,?,?,?,?,?,?,?)";
